...
A **grounded finance copilot** for individuals and small businesses, built on
[java-ai-agent](https://github.com/vaiju1981/java-ai-agent) — it consumes the published `0.3.0` platform
exactly as any third-party app would, and is the worked example of building a real product on it.

> **Status: a complete, usable product.** Login → streaming chat → `docker compose up`: a grounded
